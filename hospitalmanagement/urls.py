...
urlpatterns = [
    ...
    path('radiologistclick', views.radiologistclick_view),

    path('adminsignup', views.admin_signup_view),
    path('doctorsignup', views.doctor_signup_view, name='doctorsignup'),
    path('patientsignup', views.patient_signup_view),
    path('radiologistsignup', views.radiologist_signup_view,
         name='radiologistsignup'),
    ...
    path('radiologistlogin', LoginView.as_view(
        template_name='hospital/radiologistlogin.html')),
    ...
    path('admin-radiologist', views.admin_radiologist_view,
         name='admin-radiologist'),
    path('admin-view-radiologist', views.admin_view_radiologist_view,
         name='admin-view-radiologist'),
    path('delete-radiologist-from-hospital/<int:pk>',
         views.delete_radiologist_from_hospital_view, name='delete-radiologist-from-hospital'),
    path('update-radiologist/<int:pk>',
         views.update_radiologist_view, name='update-radiologist'),
    path('admin-add-radiologist', views.admin_add_radiologist_view,
         name='admin-add-radiologist'),
    path('admin-approve-radiologist', views.admin_approve_radiologist_view,
         name='admin-approve-radiologist'),
    path('approve-radiologist/<int:pk>',
         views.approve_radiologist_view, name='approve-radiologist'),
    path('reject-radiologist/<int:pk>',
         views.reject_radiologist_view, name='reject-radiologist'),
...
# ---------FOR Radiologists RELATED URLS-------------------------------------
urlpatterns += [
    path('radiologist-dashboard', views.radiologist_dashboard_view,
         name='radiologist-dashboard'),
    path('search', views.search_view, name='search'),

    path('radiologist-patient', views.radiologist_patient_view,
         name='radiologist-patient'),
    path('radiologist-view-patient', views.radiologist_view_patient,
         name='radiologist-view-patient'),
    path('radiologist-view-patient',
         views.radiologist_view_patient_view, name='radio-view-patient'),
